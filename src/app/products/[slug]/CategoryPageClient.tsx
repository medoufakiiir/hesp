  ...
  return (
    <main className="min-h-screen bg-brand-iron">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          ...
          >
            <motion.p variants={fadeInUp} className="text-brand-amber text-xs font-semibold uppercase tracking-widest mb-3">
              {category.productCount}+ {isArabic ? "قطعة متوفرة" : "Parts Available"}
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="mt-8">
              <Link href="/quote"
                className={`inline-flex items-center gap-3 bg-brand-amber text-white font-bold uppercase
                  ...
                  shadow-lg shadow-brand-amber/25 ${isArabic ? "font-arabic flex-row-reverse" : ""}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className={`text-brand-white font-display font-extrabold uppercase tracking-tight text-2xl mb-10
              ...
              <motion.div key={product.id} variants={scaleIn}>
                <div className="group rounded-2xl overflow-hidden border border-brand-amber/10
                  ...
                  <div className="relative h-44 overflow-hidden">
                    ...
                    {product.inStock && (
                      <div className="absolute top-3 right-3 bg-green-600/90 text-white text-[8px] font-bold
                        uppercase tracking-widest px-2 py-0.5 rounded-full flex items-center gap-1">
                  ...
                  <div className="p-4">
                    ...
                    <Link href="/quote"
                      className="flex items-center gap-2 text-brand-amber text-xs font-semibold uppercase
                        tracking-widest hover:text-brand-gold transition-colors group/btn">
          ...
          <div className="text-center py-16 bg-brand-plate rounded-2xl border border-brand-amber/10">
            ...
            <Link href="/quote"
              className="inline-flex items-center gap-2 bg-brand-amber text-white text-xs font-bold
                uppercase tracking-widest px-6 py-3 rounded-xl hover:bg-brand-gold transition-all">
