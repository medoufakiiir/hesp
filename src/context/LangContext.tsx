  ...
  AR: {
    ...
    why: {
      ...
      items: [
        ...
        { title: "توصيل سريع داخل المملكة", desc: "شحن جوي في ٣–٥ أيام. استلام في نفس اليوم في الرياض." },
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "قللت ريادة من وقت توقف أسطولنا بنسبة ٤٠٪. قطع غيار حيوية سُلِّمت في غضون ٤٨ ساعة — موثوقية لا مثيل لها.",
          name: "محمد الراشدي",
    ...
    contact: {
      ...
      phone: "+966 55 228 2868",
      email: "info@riyada-ventures.com",
      address: "الفيصلية، الرياض ١٢٨٨٢، المملكة العربية السعودية",
      hours: "الأحد – الخميس  ·  ٨:٠٠ صباحاً – ٦:٠٠ مساءً",
    },
    footer: {
